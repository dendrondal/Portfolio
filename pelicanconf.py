...
# Social widget
SOCIAL = (
    ('Twitter' 'twitter.com/dendrondal'),
...
# Navbar
M_LINKS_NAVBAR1 = [
    ('About', 'pages/about-me.html', 'about', []),
    (
        'Resume',
        'https://github.com/dendrondal/Portfolio/raw/pelican_migration/content/pages/Williams_Dal_Resume.pdf',
        'resume',
        [],
    ),
